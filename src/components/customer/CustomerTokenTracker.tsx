  ...
  return (
    <div style={{ maxWidth: '680px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ textAlign: 'center' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', backgroundColor: 'rgba(201, 162, 78, 0.15)', color: 'var(--gold-light)', padding: '0.35rem 0.85rem', borderRadius: 'var(--radius-full)', fontSize: '0.8rem', fontWeight: 700, marginBottom: '0.5rem', border: '1px solid rgba(201, 162, 78, 0.3)' }}>
          <Sparkles size={14} color="var(--gold)" /> Live Smart Queue Monitor
        </div>
      ...
      {/* Main Token Card */}
      <div className="glass-panel" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1.5rem', border: '2px solid var(--gold)', position: 'relative', overflow: 'hidden' }}>
        {/* Top Status Banner */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            ...
            <div style={{ fontSize: '2.8rem', fontWeight: 900, color: 'var(--gold-light)', lineHeight: 1.1, marginTop: '0.1rem' }}>
              {tokenNumText}
            </div>
          </div>
        ...
        <div className="stats-grid" style={{ gridTemplateColumns: 'repeat(3, 1fr)', backgroundColor: 'var(--ink)', padding: '1rem', borderRadius: 'var(--radius-lg)' }}>
          <div style={{ textAlign: 'center' }}>
            <span style={{ fontSize: '0.7rem', color: 'var(--text-muted)', textTransform: 'uppercase' }}>Currently Serving</span>
            <div style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--gold-light)', marginTop: '0.15rem' }}>
              {servingNumText}
            </div>
          </div>
          ...
          <div style={{ textAlign: 'center', borderLeft: '1px solid var(--border-subtle)', borderRight: '1px solid var(--border-subtle)' }}>
            ...
            <div style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--amber)', marginTop: '0.15rem' }}>
              {aheadCount} Ahead
            </div>
          </div>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--teal)', marginTop: '0.15rem' }}>
              {estimatedWait} mins
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', borderTop: '1px solid var(--border-subtle)', paddingTop: '1rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '0.875rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <strong style={{ color: 'var(--gold-light)' }}>{assignedStylist.name}</strong>
            </div>
          </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 'var(--radius-md)',
                    backgroundColor: isYou ? 'rgba(201, 162, 78, 0.15)' : 'var(--ink)',
                    border: isYou ? '1px solid var(--gold)' : '1px solid transparent'
                  }}
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem' }}>
                    <span style={{ fontWeight: 800, fontSize: '0.85rem', color: isYou ? 'var(--gold)' : 'var(--text-main)' }}>
                      {tokLabel}
                    </span>
